...
function Focus() {
    return (
        <div>
            <h1 className="font-heading px-5 md:px-20 pt-10 text-white text-[24px] md:text-[32px] font-bold">
                Areas of <span className="text-blue-500">Focus</span>:
            </h1>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-5 md:px-8">
