...
>>>>>>> Stashed changes
        ...
        <p className = "font-heading px-20 pt-4 text-white text-[18px]">• For beginner users, the platform lacks sufficient educational guidance on investing fundamentals, such as what investing entails and how stocks function. Instead of gradually onboarding users with foundational knowledge, the interface assumes prior understanding and directs users immediately toward investment actions.</p>
        <p className = "font-heading px-20 pt-4 text-white text-[18px]">• Options such as “Trade” and “Deposit” are presented without adequate contextual explanation, which may create confusion for new users unfamiliar with financial workflows.</p>
        <p className = "font-heading px-20 pt-4 text-white text-[18px]">• Additionally, the footer contains excessive information, contributing to cognitive overload and reducing usability.</p>
        <p className = "font-heading px-20 pt-4 text-white text-[18px]">• Within the Discover section, users are prompted to subscribe without a clear explanation of what the subscription offers, potentially reducing trust and engagement.</p>
